...
function About() {
  ...
  return (
    <>
      ...
      {/* About page sections will come here */}
      ...
      <section className="brands-section" id="our_brands">
        <div className="container-fluid">
          <div className="brands-meta">
            ...
            <p>
              TCI Dental Services prides itself on using the finest manufacturers
              in the industry for all of our materials.
            </p>
            {/* 
            <div className="partners-slider owl-carousel owl-theme">
              ...
              <div className="brands-img">
                <img src={ArmaLogo} alt="Arma Logo" />
              </div>
