...
import "../DoctorStyle/doctor-dashboardcard.css";

function DoctorDashboardCards({ totalPatients }) {
    return (
        <div className="row doctor-dashboard-cards">

            <div className="col-lg-6 col-md-6 col-12">

                <div className="doctor-dashboard-card doctor-total-patient-card">

                    <div className="doctor-dashboard-card-icon">
                        <svg
                            width="26"
                            height="22"
                            viewBox="0 0 26 22"
            ...
            <div className="col-lg-6 col-md-6 col-12">
                ...
                >
                    ...
                    <div className="doctor-dashboard-card doctor-submit-case-card">
